...
exports.createPages = async ({ actions, graphql, reporter }) => {
  ...
  const pages = {
    ...
    process: { template: path.resolve(`src/templates/snijproces.js`), pathNL: '/maalproces', pathEN: '/en/milling-process' },
    models: { template: path.resolve(`src/templates/modellen.js`), pathNL: '/modellen', pathEN: '/en/models' },
