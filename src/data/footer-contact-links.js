...
export const location = {
  ...
  FooterText: ({ isEN }) => <p><strong>Multicracker Benelux</strong><br/>Stoottroepenweg 2<br/>5363 VV Velp, {isEN ? 'Netherlands' : 'Nederland'}</p>,
  ContactText: ({ isEN }) => <p><strong>Multicracker Benelux</strong><br/>Stoottroepenweg 2<br/>5363 VV Velp, {isEN ? 'Netherlands' : 'Nederland'}<br/>KvK nummer: 20132623</p>,
}