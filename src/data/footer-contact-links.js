...
export const links = [
  { Icon: CallIcon, link: "tel:0031486421510", text: "+31(0)486 421510", label: "Telefoon", labelEN: "Phone" },
...
export const location = {
  ...
  FooterText: ({ isEN }) => <p>Ben Janssen-Bouwmeester<br/>Stoottroepenweg 2<br/>5363 VV Velp, {isEN ? 'Netherlands' : 'Nederland'}</p>,
  ContactText: ({ isEN }) => <p><strong>Multicracker Benelux</strong><br/>Ben Janssen-Bouwmeester<br/>Stoottroepenweg 2<br/>5363 VV Velp, {isEN ? 'Netherlands' : 'Nederland'}<br/>KvK nummer: 20132623</p>,
}